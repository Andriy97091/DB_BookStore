...
values ('1', '1', '4', '1', '3', 'Три мушкетери', '72');
insert into books  (id, author_id, genre_id, pub_house_id, series_id, title, price)
...
insert into books  (id, author_id, genre_id, pub_house_id, series_id, title, price)
values ('23', '7', '10', '5', '1', 'Анна Кареніна', '82');
insert into books  (id, author_id, genre_id, pub_house_id, series_id, title, price)
...
insert into author
values('4','Агата Мері','Міллер', 'Агата Мері Кларисса Міллер','1890-0918','Велика Британія');
insert into author
...
values('2', '1', '1', '1А-1', '12013-05-13');
insert into orders (id, customer_id, employee_id, parcel_number, ordertime)
values('3', '1', '2', '2Б-2', '2013-05-13');
insert into orders (id, customer_id, employee_id, parcel_number, ordertime)
values('4', '2', '3', '3В-3', '2013-05-13');
insert into orders (id, customer_id, employee_id, parcel_number, ordertime)
values('5', '3', '3', '4Г-4', '2013-05-13');
insert into orders (id, customer_id, employee_id, parcel_number, ordertime)
values('6', '4', '4', '5Д-5', '2013-05-13');
insert into orders (id, customer_id, employee_id, parcel_number, ordertime)
values('7', '5', '5', '6А-6', '2013-05-13');
insert into orders (id, customer_id, employee_id, parcel_number, ordertime)
values('8', '6', '1', '7Б-7', '2013-05-14');
insert into orders (id, customer_id, employee_id, parcel_number, ordertime)
values('9', '1', '3', '8В-8', '2013-05-14');
insert into orders (id, customer_id, employee_id, parcel_number, ordertime)
values('10', '2', '1', '9Г-9', '2013-05-14');
...
insert into employee (id, first_name, last_name, adress)
